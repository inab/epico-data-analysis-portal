...
factory('ConstantsService',function() {
	...
	var REGION_FEATURES = [ REGION_FEATURE_GENE , REGION_FEATURE_TRANSCRIPT, REGION_FEATURE_UTR, REGION_FEATURE_EXON, REGION_FEATURE_CDS, REGION_FEATURE_START_CODON, REGION_FEATURE_STOP_CODON ];
	...
	return {
		...
		REGION_FEATURE_EXON: REGION_FEATURE_EXON,
		REGION_FEATURE_CDS: REGION_FEATURE_CDS,
		REGION_FEATURE_UTR: REGION_FEATURE_UTR,
		REGION_FEATURE_SELENOCYSTEINE: REGION_FEATURE_SELENOCYSTEINE,
